<<<<<<< Updated upstream:lib/screens/buscar_abogado_map_screen.dart
...
class _BuscarAbogadoMapScreenState extends State<BuscarAbogadoMapScreen> {
  ...
  Future<void> obtenerUbicacionYAbogados() async {
    try {
      ...
      // Consumir API de abogados
      final url = Uri.parse(
          'https://corporativolegaldigital.com/api/listar-abogados.php');
      final respuesta = await http.get(url);
                            ...
                            markers: [
                              ...
                              ...abogados.map((abogado) {
                                final lat = double.tryParse(
                                    abogado['latitude'].toString());
                                final lng = double.tryParse(
                                    abogado['longitude'].toString());
                                if (lat == null || lng == null) {
                                  return const Marker(
                                    point: LatLng(0, 0),
                                    width: 0,
...
>>>>>>> Stashed changes:lib/screens/abogados/buscar_abogado_map_screen.dart
